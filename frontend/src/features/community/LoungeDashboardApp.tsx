              ...
              <div className="xl:col-span-2 space-y-8">
                ...
                <section className="animate-[fadeIn_0.5s_ease-in-out]" style={{ animationDelay: '0.2s' }}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-gray-200 border-l-4 border-l-[#00c471] shadow-sm cursor-pointer group flex flex-col md:flex-row gap-5 items-start md:items-center justify-between [transition:all_0.2s_ease] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.08)] hover:[transform:translateY(-3px)_scale(1.02)]" onClick={() => goTo(getRecommendationTarget(recommendedProject))}>
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-2">
                    ...
                    {hotShowcase ? (
                      <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm cursor-pointer flex flex-col md:flex-row gap-5 items-start md:items-center justify-between group [transition:all_0.2s_ease] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.08)] hover:[transform:translateY(-3px)_scale(1.02)]" onClick={() => goTo('/dev-showcase')}>
