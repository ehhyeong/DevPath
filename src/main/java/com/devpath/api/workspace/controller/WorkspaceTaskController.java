...
public class WorkspaceTaskController {
  ...
  public ApiResponse<WorkspaceTaskResponse> createTask(
    ...
    return ApiResponse.ok(
        workspaceTaskService.createTask(workspaceId, requireUserId(userId), request));
  }
  ...
  public ApiResponse<WorkspaceTaskResponse> updateTask(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.ok(
        workspaceTaskService.updateTask(workspaceId, taskId, requireUserId(userId), request));
  }
  ...
  public ApiResponse<WorkspaceTaskResponse> updateTaskAssignee(
    ...
    return ApiResponse.ok(
        workspaceTaskService.updateTaskAssignee(
            workspaceId, taskId, requireUserId(userId), request));
  }
  ...
  public ApiResponse<List<WorkspaceTaskResponse>> getUnresolvedTasks(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.ok(
        workspaceTaskService.getUnresolvedTasks(workspaceId, requireUserId(userId)));
  }
}
