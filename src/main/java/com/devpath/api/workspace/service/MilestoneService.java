...
public class MilestoneService {
  ...
  public MilestoneResponse createMilestone(
      Long workspaceId, Long userId, CreateMilestoneRequest request) {
  ...
  public MilestoneResponse updateMilestone(
      Long milestoneId, Long userId, UpdateMilestoneRequest request) {
  ...
  private Milestone getMilestoneEntity(Long milestoneId) {
    return milestoneRepository
        .findByIdAndIsDeletedFalse(milestoneId)
