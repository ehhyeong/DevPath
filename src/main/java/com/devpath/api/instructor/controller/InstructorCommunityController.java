...
public class InstructorCommunityController {
    ...
    public ApiResponse<CommunityPostResponse> createPost(
        ...
        return ApiResponse.success(
                "게시글이 생성되었습니다.",
                instructorCommunityService.createPost(userId, request)
        );
    }
    ...
    public ApiResponse<CommunityPostResponse> updatePost(
        ...
        return ApiResponse.success(
                "게시글이 수정되었습니다.",
                instructorCommunityService.updatePost(userId, postId, request)
        );
    }
    ...
    @Operation(
            summary = "채널 게시글 목록 조회",
            description = "정렬(sort=latest/popular), 타입(type=NOTICE/GENERAL) 필터 지원"
    )
    @GetMapping("/posts")
    public ApiResponse<List<CommunityPostResponse>> getPosts(
        ...
        return ApiResponse.success(
                "게시글 목록 조회 성공",
                instructorCommunityService.getPosts(instructorId, sort, type)
        );
    }
    ...
    public ApiResponse<CommunityCommentResponse> addComment(
        ...
        return ApiResponse.success(
                "댓글이 등록되었습니다.",
                instructorCommunityService.addComment(postId, userId, request)
        );
    }
    ...
    public ApiResponse<CommunityCommentResponse> addReply(
        ...
        return ApiResponse.success(
                "대댓글이 등록되었습니다.",
                instructorCommunityService.addReply(commentId, userId, request)
        );
    }
    ...
    public ApiResponse<CommunityCommentResponse> updateComment(
        ...
        return ApiResponse.success(
                "댓글이 수정되었습니다.",
                instructorCommunityService.updateComment(userId, commentId, request)
        );
    }
