...
import com.devpath.api.instructor.service.InstructorQnaAnswerService;
import com.devpath.api.instructor.service.InstructorQnaInboxQueryService;
import com.devpath.api.instructor.service.InstructorQnaTemplateService;
...
public class InstructorQnaInboxController {
  ...
  private final InstructorQnaInboxQueryService inboxQueryService;
  private final InstructorQnaAnswerService answerService;
  private final InstructorQnaTemplateService templateService;
  ...
  public ApiResponse<List<QnaInboxResponse>> getInbox(
    ...
    return ApiResponse.success("QnA Inbox 조회 성공", inboxQueryService.getInbox(userId, status));
  }
  ...
  public ApiResponse<Void> updateStatus(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    answerService.updateStatus(questionId, userId, request);
  ...
  public ApiResponse<QnaDraftResponse> saveDraft(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.success("임시저장되었습니다.", answerService.saveDraft(questionId, userId, request));
  }
  ...
  public ApiResponse<QnaAnswerResponse> createAnswer(
    ...
    return ApiResponse.success(
        "답변이 등록되었습니다.", answerService.createAnswer(questionId, userId, request));
  }
  ...
  public ApiResponse<QnaAnswerResponse> updateAnswer(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.success(
        "답변이 수정되었습니다.", answerService.updateAnswer(questionId, answerId, userId, request));
  }
  ...
  public ApiResponse<QnaTimelineResponse> getTimeline(
      @PathVariable Long questionId,
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.success("타임라인 조회 성공", inboxQueryService.getTimeline(questionId, userId));
  }
  ...
  public ApiResponse<QnaTemplateResponse> createTemplate(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.success("템플릿이 등록되었습니다.", templateService.createTemplate(userId, request));
  }
  ...
  public ApiResponse<List<QnaTemplateResponse>> getTemplates(
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.success("템플릿 목록 조회 성공", templateService.getTemplates(userId));
  }
  ...
  public ApiResponse<QnaTemplateResponse> updateTemplate(
      ...
      @Parameter(hidden = true) @AuthenticationPrincipal Long userId) {
    return ApiResponse.success(
        "템플릿이 수정되었습니다.", templateService.updateTemplate(templateId, userId, request));
  }
