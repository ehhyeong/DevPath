...
import com.devpath.api.analytics.service.AdminAnalyticsService;
...
public class AdminAnalyticsController {
  ...
  public ResponseEntity<ApiResponse<ExperimentResultResponse>> createExperiment(
      @Valid @RequestBody ExperimentRequest.Create request) {
    return ResponseEntity.ok(ApiResponse.ok(analyticsService.createExperiment(request)));
  }

  @PatchMapping("/experiments/{experimentId}/status")
  public ResponseEntity<ApiResponse<ExperimentResultResponse>> changeExperimentStatus(
      @PathVariable String experimentId,
      @Valid @RequestBody ExperimentRequest.ChangeStatus request) {
    return ResponseEntity.ok(ApiResponse.ok(analyticsService.changeStatus(experimentId, request)));
  }

  @PutMapping("/experiments/{experimentId}/results")
  public ResponseEntity<ApiResponse<ExperimentResultResponse>> saveExperimentResult(
      @PathVariable String experimentId, @Valid @RequestBody ExperimentRequest.SaveResult request) {
    return ResponseEntity.ok(ApiResponse.ok(analyticsService.saveResult(experimentId, request)));
  }
