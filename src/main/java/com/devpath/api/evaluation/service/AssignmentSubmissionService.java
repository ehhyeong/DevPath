...
public class AssignmentSubmissionService {
  ...
  public SubmissionResponse createSubmission(
    ...
    boolean isLate =
        assignment.getDueAt() != null && LocalDateTime.now().isAfter(assignment.getDueAt());
    ...
    Submission submission =
        Submission.builder()
            ...
            .learner(learner)
            .submissionText(
                submissionMethods.allowText() ? trimToNull(request.getSubmissionText()) : null)
            .submissionUrl(
                submissionMethods.allowUrl() ? trimToNull(request.getSubmissionUrl()) : null)
            .submissionStatus(SubmissionStatus.PRECHECK_PENDING)
            .build();

    submission.applyPrecheckResult(
  ...
  public SubmissionHistoryResponse getSubmissionHistory(Long userId) {
    ...
    List<Submission> submissionList =
        submissionRepository.findAllByLearnerIdAndIsDeletedFalseOrderBySubmittedAtDesc(userId);
