...
public class RoadmapController {
    ...
    public ApiResponse<RoadmapDto.DetailResponse> getOfficialRoadmapDetail(@PathVariable Long roadmapId) {
        return ApiResponse.success("로드맵 상세 트리 조회 성공", roadmapService.getOfficialRoadmapDetail(roadmapId));
    }
}